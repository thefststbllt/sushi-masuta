    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="53" height="53" fill="none">
            ...
            <path fill="#D74D67" fill-rule="evenodd"
                  ...
                  clip-rule="evenodd"/>
            <ellipse cx="26.945" cy="25.219" fill="#fff" rx="13.132" ry="11.938"
                     transform="rotate(-30.214 26.945 25.219)"/>
            <ellipse cx="26.707" cy="24.203" fill="#0DBE70" rx="8.345" ry="6.948"
                     transform="rotate(-30.214 26.707 24.203)"/>
